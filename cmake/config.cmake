...
# Use file(STRINGS) instead of grep for Windows portability.
file(STRINGS "${CONFIG_H}" _pqxx_config_lines REGEX "PQXX")
file(WRITE "${CONFIG_H_COM}" "")
foreach(_line IN LISTS _pqxx_config_lines)
    file(APPEND "${CONFIG_H_COM}" "${_line}\n")
endforeach()
